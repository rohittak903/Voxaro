...
export const TextEditor: React.FC = () => {
  ...
  const { planDetails, t, showToast } = useUser();
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
            {isGenerating ? (
              <button
                ...
                className="px-4 py-3 rounded-xl text-xs font-semibold bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-300 transition-colors"
              >
                Cancel
              </button>
            ) : (
